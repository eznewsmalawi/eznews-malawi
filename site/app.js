...
(function () {
  ...
  const STRINGS = {
    en: {
      ...
      footer_about: "ezNews Malawi gives you the day's biggest stories in easy to understand writing. We always link to the original sources. We update twice a day, in the morning and in the evening.",
    ...
    ny: {
      ...
      footer_about: "ezNews Malawi imalemberanso nkhani zazikulu za tsikulo m'Chingelezi chosavuta (A1) ndi Chichewa (A2). Timalumikiza nthawi zonse ku magwero oyambirira. Timasintha nkhani kawiri patsiku, m'mawa ndi madzulo.",
